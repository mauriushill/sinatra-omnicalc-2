...
get("/wizard_subtract") do
  @first_num = params.fetch("minus_number").to_f
  @second_num = params.fetch("minus_number_two").to_f
  @result = @first_num - @second_num
...
get("/wizard_multiply") do
  @first_num = params.fetch("multi_one").to_f
  @second_num = params.fetch("multi_two").to_f
  @result = @first_num * @second_num
  erb(:mult_result)
end
